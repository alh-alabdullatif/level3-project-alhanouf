...
cart:
	kubectl apply -f tekton/kaniko/cart-build-task.yaml -f tekton/test-deploy/deploy/carts-deploy-task.yaml -f tekton/test-deploy/test/test-task.yaml -f tekton/pipelines/cart-pipeline.yaml -n test
cart-delete:
...
catalouge:
	 kubectl apply -f tekton/kaniko/cat-build-task.yaml -f tekton/kaniko/cat-db-build-task.yaml -f tekton/test-deploy/deploy/cat-deploy-task.yaml -f tekton/test-deploy/test/test-task.yaml -f tekton/pipelines/cat-pipeline.yaml -n test
...
front-end-delete:
	kubectl delete -f tekton/kaniko/git-clone-task.yaml -f tekton/kaniko/fe-build-task.yaml -f tekton/test-deploy/deploy/fe-deploy-task.yaml -f tekton/test-deploy/test/test-task.yaml -f tekton/pipelines/fe-pipeline.yaml -n test
front-end-logs:
	tkn pr logs -f fe-pipeline-run -n test
orders:
	kubectl apply -f tekton/kaniko/ord-build-task.yaml -f tekton/test-deploy/deploy/ord-deploy-task.yaml -f tekton/test-deploy/test/test-task.yaml -f tekton/pipelines/ord-pipeline.yaml -n test
...
payment:
	kubectl apply -f tekton/kaniko/pay-build-task.yaml -f tekton/test-deploy/deploy/pay-deploy-task.yaml -f tekton/test-deploy/test/test-task.yaml -f tekton/pipelines/pay-pipeline.yaml  -n test
payment-delete:
...
q-master:
	kubectl apply -f tekton/kaniko/q-master-build-task.yaml -f tekton/test-deploy/deploy/q-master-deploy-task.yaml -f tekton/test-deploy/test/test-task.yaml -f tekton/pipelines/q-master-pipeline.yaml -n test
...
shipping:
	kubectl apply -f tekton/kaniko/shipping-build-task.yaml -f tekton/test-deploy/deploy/shipping-deploy-task.yaml -f tekton/test-deploy/test/test-task.yaml -f tekton/pipelines/shipping-pipeline.yaml -n test
shipping-delete:
...
user:
	kubectl apply -f tekton/kaniko/user-db-build-task.yaml -f tekton/kaniko/user-build-task.yaml -f tekton/test-deploy/deploy/user-deploy-task.yaml -f tekton/test-deploy/test/test-task.yaml -f tekton/pipelines/user-pipeline.yaml -n test
